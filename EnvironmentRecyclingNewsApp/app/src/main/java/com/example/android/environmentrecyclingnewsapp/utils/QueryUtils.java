package com.example.android.environmentrecyclingnewsapp.utils;
...
public class QueryUtils {
    ...
    public static final String ARTICLE_REQUEST_URL = "https://content.guardianapis.com/search?tag=environment/recycling&api-key=test";
    ...
    private static List<Article> extractFeatureFromJson(String jsonResponse) {
        ...
        try {
            ...
            for (int i = 0; i < articleArray.length(); i++) {
                ...
                String articleUrl = currentArticle.optString("webUrl");

                articles.add(new Article(articleTitle, articleSection, articleUrl));
            }
